    ...
    <>
      ...
      <nav className="bg-gradient-to-r from-green-500 via-green-600 to-green-700 p-6 shadow-xl">
        <div className="flex flex-wrap justify-center gap-6">
          {[ 
            { label: "Car Stereos", to: "/carelectronics/carstereos" },
            { label: "Dash Cams", to: "/carelectronics/dashcams" },
            { label: "Parking Cameras", to: "/carelectronics/parkingcameras" },
            { label: "Car Chargers", to: "/carelectronics/carchargers" },
            { label: "Car Air Purifiers", to: "/carelectronics/carairpurifiers" },
          ].map((item, index) => (
            <Link
              key={index}
              to={item.to}
